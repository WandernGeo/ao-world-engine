...
-- Load all 800 NPCs with full data (personalities, families, desires)
-- This file is generated by scripts/convert_npcs_to_lua.py
...
function Initialize(custom_config)
    ...
    FoundingNPCs = {}
    local founding_module = require("founding_npcs")
    if founding_module and founding_module.FOUNDING_NPCS then
        ...
        print("   - Warning: founding_npcs.lua not loaded")
    end
    print("")
